return {}
-- Old but actualyl works.. for now.. copied kickstart bs and included it in lsp-postv11 because documentation was not very great imo to replicate what I had done here on my own.. Also deleted old plugins that were manually handled (formatter, linter, nvim-cmp). Can be found in git history
-- return {
--     {
